...
plt.savefig(Path(args.corr_matrix_output) / 'corr_matrix.jpg',bbox_inches='tight',dpi=100)

water_potability_df.to_csv(Path(args.data_clean_output) / 'clean-data.csv')